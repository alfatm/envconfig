...
func TestParseURL(t *testing.T) {
	...
	os.Clearenv()
	os.Setenv("ENV_CONFIG_URLVALUE", "https://github.com/alfatm/envconfig")
	os.Setenv("ENV_CONFIG_URLPOINTER", "https://github.com/alfatm/envconfig")
	...
	u, err := url.Parse("https://github.com/alfatm/envconfig")
	if err != nil {
