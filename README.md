...
[![Build Status](https://travis-ci.org/alfatm/envconfig.svg)](https://travis-ci.org/alfatm/envconfig)

```Go
import "github.com/alfatm/envconfig"
```

## Documentation

See [godoc](http://godoc.org/github.com/alfatm/envconfig)
